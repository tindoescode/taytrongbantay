    ...
    <div>
      ...
      <main>
       <form method="POST" className="mt-2">
            <Title>Đăng ký</Title>
            <div className="flex flex-col space-y-4 select-none shadow-md p-2">
              ...
              <button onClick={loginBtnClicked} className="bg-green-400 p-4 hover:bg-green-600 transition text-white" type="submit">Đăng ký</button>              
