  ...
  return (
    <>
      <div className="flex items-center shadow-md md:justify-around fixed w-screen top-0 bg-white z-50">
        ...
        <div className="flex-grow justify-end md:flex-grow-0 Navbar mr-2">
          <div className="Navbar--item hover:bg-green-300 hover:text-white transition md:relative">
            ...
            <div
              className={
                `mx-1 md:mx-0 login-form rounded-md flex absolute ` +
                `flex-col border bg-gray-200 shadow-sm select-none` +
                `box-border transition-all duration-1000 ease h-0 ${
                  loginMenu === false ? "h-0" : "h-auto p-2"
                } right-0`
              }
              style={{ top: "3.1rem" }}
            >
                ...
                <form>
                  <div className="flex items-center justify-end">
                    ...
                    <input
                      ref={inputName}
                      name="username"
                      className="rounded p-2 mt-2 ring-1 ring-green-500 text-black"
                  ...
                  <div className="flex items-center justify-end">
                    ...
                    <input
                      ...
                      name="password"
                      type="password"
                      className="rounded p-2 my-2 ring-1 ring-green-500 text-black"
                  ...
                  <button
                    ...
                    className="rounded p-2 bg-green-300 hover:bg-green-500 text-white transition"
                  >
                    Đăng nhập
                  </button>
                  ...
                  <p className="text-black">
                    ...
                    <Link href="/register">
                      <a className="font-bold hover:text-green-700 transition">
                        Đăng ký ngay!
                      </a>
                    </Link>
                  </p>
          ...
          <div className="Navbar--item hover:bg-green-300 hover:text-white transition">
            <svg
              ...
              fill="currentColor"
              className="bi bi-suit-heart stroke-1"
              viewBox="-2 -5 20 20"
              preserveAspectRatio="xMidYMid slice"
            >
